...
>
  <img
    ...
    className="w-60 sm:w-72 md:w-80 object-contain transition-transform duration-300 ease-in-out hover:scale-105 hover:drop-shadow-[0_0_20px_rgba(255,255,255,0.4)]"
  />
</motion.div>
