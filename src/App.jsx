...
>
  <img
    ...
    className="h-20 sm:h-24 md:h-28 lg:h-32 object-contain drop-shadow-2xl transition-transform duration-300 ease-in-out hover:scale-105 hover:drop-shadow-[0_0_20px_rgba(255,255,255,0.4)]"
  />
</motion.div>
